...
<body>
    <div class="acacac">
        <h3>
            <img src="https://pics.auction.co.kr/myauction/2011/tit_nav_memberinfo.gif" alt="회원정보"></h3>
        <ul>
            <li class=""><a href="http://through.auction.co.kr/common/SafeRedirect.aspx?cc=0C5D&amp;next=https://memberssl.auction.co.kr/Membership/MyInfo/MyInfo.aspx" target="_top">
                <img src="https://pics.auction.co.kr/myauction/2011/txt_nav_memberinfo_01.gif" alt="회원정보수정"></a></li>
            <li class=""><a href="http://through.auction.co.kr/common/SafeRedirect.aspx?cc=0C5D&amp;next=http://member.auction.co.kr/Credit/MyStatus.aspx" target="_top">
                <img src="https://pics.auction.co.kr/myauction/2011/txt_nav_memberinfo_02.gif" alt="회원상태"></a></li>
            <li class=""><a href="http://through.auction.co.kr/common/SafeRedirect.aspx?cc=0C5D&amp;next=http://member.auction.co.kr/MyHome/Odr/OdrAnswerList.aspx" target="_top">
                <img src="https://pics.auction.co.kr/myauction/2011/txt_nav_memberinfo_03.gif" alt="경매벌점차감"></a></li>
            <li><a href="javascript:Events.AddressBookPopup();">
                <img src="https://pics.auction.co.kr/myauction/2011/txt_nav_memberinfo_05.gif" alt="배송주소록"></a></li>
        </ul>
    </div>
    <div id="header_wrap">
        <div id="core_lnb">
    ...
    <div class="mini_header_faq">
        <a href="http://member.auction.co.kr/myauction/default.aspx" target="_top">
            <img src="https://pics.auction.co.kr/myauction/mini_header/2014/mini_header_tit.png" alt="마이옥션"></a>
      
    </div>
    <div class="uxc-tit-area">
        <h3><img src="https://pics.auction.co.kr/myauction/2012/tit_recent_order_list.gif" alt="최근 주문 내역"> 
        </h3>
        <div class="view-option">
                <select name="ddlOrderStatus" onchange="javascript:setTimeout('__doPostBack(\'ddlOrderStatus\',\'\')', 0)" id="ddlOrderStatus">
<option value="1">주문상태 전체 (0)</option>
<option selected="selected" value="102">입금확인중 (0)</option>
<option value="170">결제완료 (0)</option>
<option value="2011">배송준비중 (0)</option>
<option value="2051">배송중 (0)</option>
<option value="2052">배송완료 (0)</option>
<option value="9901">거래완료 (1)</option>
<option value="2053">구매결정대기 (0)</option>
<option value="410">반품신청중 (0)</option>
<option value="414">반품보류 (0)</option>
<option value="2012">취소대기중 (0)</option>
<option value="420">교환신청중 (0)</option>
<option value="424">교환지연 (0)</option>
<option value="403">환불예정 (0)</option>
<option value="995">환불완료 (0)</option>
<option value="702">판매취소 (0)</option>
<option value="997">직권취소 (0)</option>
<option value="402">주문취소(미입금) (0)</option>
<option value="802">구매거부(미입금) (0)</option>
    ...
    <table id="tblContents" class="order-list-table">
...
<tbody id="asynchtml" style="display:none;">
        </tbody>
    </table>
