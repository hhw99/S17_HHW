		...
		<div id="header">
					...
					<div id="buttons">
						...
						<div class="buttons_first_hover">
							...
							<div>
								...
								<div>
									<button onclick="location.href="${pageContext.request.contextPath }/login.html';">
										<span>로그인</span>
									</button>
									<button>
										<img
			...
			<div id="h_second">
				<div class="h_s_1">
					...
					<ul id="s_list">
						<li onclick="location.href="${pageContext.request.contextPath }/category.html';"><span
											...
											<div class="m_s_4_list_1_product_1">
												<div class="m_s_4_list_1_product_1_img">
													...
													<button type="button" class="m_s_4_list_1_product_1_button">
														<img
															src="${pageContext.request.contextPath }/images/상품_장바구니.svg"
															alt="장바구니 아이콘" onclick="location.href="${pageContext.request.contextPath }/shopping_basket_loggedIn.html';">
													</button>
												</div>
												<div class="m_s_4_list_1_product_1_content">
													<h3 class="m_s_4_list_1_product_1_content_title">
