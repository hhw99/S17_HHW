...
<body>
    <div id="container">
        <div id="login-app">
            ...
            <ul class="list__tab" id="login_tab" style="display: block;">
                <li class="list-item__tab list-item__tab--active"><button class="button__tab" id="login_tab_member" onclick="setLoginTabType('member');">회원</button></li>
                <li class="list-item__tab"><button class="button__tab" id="login_tab_non_member" onclick="setLoginTabType('nonmember');">비회원 주문조회</button></li>
            </ul>
            <div class="box__tab-contents box__login-member box__tab-contents--active">
                <fieldset class="form__login-member">
                    <legend class="for-a11y">회원 로그인</legend>
                    <!-- to.dev : submint 후 validate-warning 메세지 노출될 경우 tabindex="0" attribute 추가 해 주세요. -->
                    <p class="text__message-error" id="error_msg" style="display: none;"></p>
                    <div class="box__message-error" id="error_msg_box" style="display: none;">
                        <p class="text__message-error" id="error_msg_in_box"></p>
                        <p class="text__message-error" id="login_error_4" style="display: none"><a href="javascript:newHelpPop('E03009');" class="link__underline">로그인 제한 사유 문의하기</a></p>
                    ...
                    <ul class="list__form-input">
                        <li class="list-item__form-input" data-index="0">
                            ...
                            <label for="id" class="for-a11y">아이디</label>
                            <input type="text" id="id" name="id" placeholder="아이디" class="form__input-text" value="" onkeydown="return keycheck2(this.event);" tabindex="1" maxlength="20">
                            <button class="button__input-delete sprite__login">삭제</button>
                            <p class="text__validate-warning" style="display: none;">아이디를 입력해주세요.</p>
                        </li>
                        <li class="list-item__form-input" data-index="1">
                            <label for="pwd" class="for-a11y">비밀번호</label>
                            <input type="password" id="password" name="password" placeholder="비밀번호" class="form__input-text" onkeydown="return keycheck(this.event);" tabindex="2">
                            <button class="button__input-delete sprite__login">삭제</button>
                    ...
                    <input type="hidden" id="socialSessionId" name="socialSessionId" value="">
                    <input type="hidden" id="auctionHelp" name="auctionHelp" value="0">
                    <input type="hidden" id="faceData" name="faceData" value="">
                    <input type="hidden" id="uniqueKey" name="uniqueKey" value="1bd51266b1624fcdab84f448c18b4686">
                    <button type="button" class="button__submit button__nomember" style="display: none;">비회원으로 구매하기</button>
